    ...
    <div class="row">
      <div class="col-md-5 text-container">
        ...
        <div class="section-link">
          <a href="http://localhost/festival/festival/" class="btn btn-custom">Voir Plus</a>
...
<section id="actuality">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="section-link">
          ...
          <a href="http://localhost/festival/category/actualites/" class="btn btn-custom">Voir Plus</a>
        </div>
      </div>
    </div>
    ...
    <?php 
      ...
      $featuredPosts = new WP_Query(array( 'posts_per_page' => 3 ));
  ...
  <div class="container">
    <div class="row contact-content">
      ...
      <div class="col-md-4 action-button-container">
        <a href="http://localhost/festival/contact/" class="btn btn-custom">Contactez-nous</a>
      </div>
...
<section id="day-projections">
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-5"> <!-- colonne de gauche-->
        ...
        <div class="cf-margin-bottom">
          ...
          <div class="section-link">
            <a href="http://localhost/festival/diffusions" class="btn btn-custom">Voir Plus</a>
        ...
        <div class="col-sm-5 col-sm-offset-2"> <!-- colonne de doite-->
          ...
          <div class="cf-margin-bottom">
            ...
            <figure class="figure-2">
              <img src="<?php echo get_image_theme_path('thevoid.jpg'); ?>" alt="">
              <figcaption class="caption">
                <div class="blur"></div>
                <div class="action-button-container">
                  <a href="http://localhost/festival/film/" class="btn btn-custom">Plus de détails</a>
